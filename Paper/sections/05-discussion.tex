...
Subsequent iterations should complete the \num{1266}-clip training run, report holdout and live-session metrics in notebook~06, compare frozen V-JEPA~2 against DINOv2 and MC-JEPA heads under identical sampling, integrate per-person inference with the VisionOps backend services, and evaluate on held-out \inhard{} subjects not seen during stratified sampling.

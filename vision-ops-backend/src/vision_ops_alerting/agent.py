...
from vision_ops_alerting.services.alert_snapshot import SnapshotAsset
...
def _dispatch_email(
    ...
    *,
    ...
    if db_template is not None:
        ...
        tpl = render_email_template(db_template, ctx, snapshot_asset=snapshot_asset)
    else:
    ...
    if not settings.from_email:
        raise RuntimeError("Missing VISIONOPS_FROM_EMAIL")
...
def send_email_for_case_type(
    ...
    *,
    ...
    message_ids, dry_run, tpl = _dispatch_email(
        ctx,
        classified,
        db_template=db_template,
        snapshot_asset=snapshot_asset,

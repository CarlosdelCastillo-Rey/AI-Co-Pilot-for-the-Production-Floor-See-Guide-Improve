...
PAGE_SCREEN: dict[str, dict[str, str]] = {
    ...
    "vision-lab": {
        "label": "Vision Lab",
        "focus": "vision probes, baselines, and model behavior on cameras",
        "actions": "interpret probe results before trusting live anomaly scores",
    },
    "identity": {
        "label": "Identity",
        "focus": "operator face enrollment for recognition overlays",
        "actions": "confirm enrollment quality and privacy-safe storage",
    },
    "dashboard": {
        "label": "Dashboard",
